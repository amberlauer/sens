...
export MESA_RUN=/work/al363/runs/low_overhead/xfactor_number_1b
...
cd $MESA_RUN/${index2}
cp $MESA_BASE/inlist_cluster_1b_templatefactor  ./inlist_cluster_low_overhead_1b
rxn1=$(sed -n ''${index2}'p' $MESA_BASE/reaction_list_305_10108.txt)
sed -i 's|reaction_name1|'$rxn1'|g'  inlist_cluster_low_overhead_low_overhead_1b
rxn2=$(sed -n ''${index1}'p' $MESA_BASE/reaction_list_305_10108.txt)
sed -i 's|reaction_name2|'$rxn2'|g'  inlist_cluster_low_overhead_low_overhead_1b
max_model=$(sed -n ''${index3}'p' $MESA_BASE/1b/max_model_xfactor_number.txt)
sed -i 's|max_numb|'${max_model}'|g'  inlist_cluster_low_overhead_low_overhead_1b
