...
#SBATCH --job-name=sensitivity_10108_wk_both_.01
...
export MESA_RUN=$MESA_BASE/runs_x.01_wk_both
...
if $empty; then
    ...
    if ls ./final_profile* 1> /dev/null 2>&1; then
    	echo "this_model_is_finished"  >> /work/al363/sens/errors/slurm._${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.err 
    else	
    	echo "starting from photo" >> /work/al363/sens/errors/slurm._${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.err 
