...
export MESA_RUN=/work/al363/runs/runs_x100_3
...
max_model=$(sed -n ''${index}'p' ./1b/max_model_x100_3.txt)
model=$(sed -n ''${index}'p' ./1b/restart_model_x100_3.txt)
