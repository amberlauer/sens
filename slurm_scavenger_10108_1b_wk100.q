...
#SBATCH --job-name=sensitivity_10108_wk_100
...
max_model=$(sed -n ''${index3}'p' $MESA_BASE/1b/max_model_x100_wk.txt)
sed -i 's|max_numb|'${max_model}'|g'  inlist_cluster

model=$(sed -n ''${index3}'p' $MESA_BASE/1b/restart_model_x100_wk.txt)
