...
#SBATCH --job-name=sensitivity_10108_redos
#SBATCH --output=errors/slurm._%A_%a.err
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --mem-per-cpu=3072
#SBATCH --array=879,1510,1511,1512,1513,1514
...
export MESA_RUN=/work/al363/runs/runs_x.01_redos
...
if $empty; then
    ...
    cd $MESA_RUN/${index2}
    if stat --printf='' ./final_profile* 2>/dev/null; then
