...
end=int(input('Enter the number associated with the last model folder:')) + 2
run_num = []
rxn_list = []
...
for j in range(start, end, 2):
    ...
    if j == end:
        s = 'baseline_abund'
        path1 = '/datacommons/phy-champagne-lauer/'
    else:
        s = str(j) # changes int j into string s
...
csv_path = data_loc +runs_folder + 'results/new_mass_frac_' + runs_name + '.csv'
