...
#SBATCH --job-name=sensitivity_10108_13
#SBATCH --output=errors/slurm._%A_%a.err
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --mem-per-cpu=2096
#SBATCH --array=10,13,100,289,400,500,600,649
...
export MESA_RUN=/work/al363/runs/e_makeups

#mkdir $MESA_BASE/runs_x100_13
...
max_model=$(sed -n ''${index3}'p' $MESA_BASE/1b/max_model_x.01_13.txt)
sed -i 's|max_numb|'${max_model}'|g'  inlist_cluster

model=$(sed -n ''${index3}'p' $MESA_BASE/1b/restart_model_x.01_13.txt)
