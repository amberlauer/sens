...
! ***********************************************************************
      ...
      integer function extras_finish_step(id, id_extra)
         ...
         integer, intent(in) :: id, id_extra
         real(dp), parameter :: log_L_hi = 0.9d0, log_L_lo = -0.4d0 
         integer :: ierr
         type (star_info), pointer :: s
         include 'formats'
         ierr = 0
...
!!!!  
      subroutine my_pgstar_plots_info(id, ierr)
         ...
         if (ierr /= 0) return
			...
			p% file_interval = burst_file_cnt
      ...
      subroutine set_my_namelist_defaults
		 ...
		 burst_xaxis_by = 'star_age_hr' ! same choices as for main window xaxis_by
